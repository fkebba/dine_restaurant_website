export function form() {
    return `
    <div class="absolute lg:top-5/9 mx-auto sm:top-5/7 top-5/12 lg:bottom-0 lg:right-0 lg:left-5/10 px-6 md:px-28 lg:px-0  lg:max-w-1/2 w-full lg:pr-24  flex items-center justify-center p-8">
