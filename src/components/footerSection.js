...
<footer class="bg-black text-white">
    <div class="py-16 px-8 bg-cover bg-center" style="background-image: url('/public/images/homepage/ready-bg-desktop.jpg'); ">
      <div class="max-w-5xl mx-auto flex flex-col lg:flex-row justify-between items-center">
        <h2 class="text-4xl md:text-5xl mb-8 md:mb-0 text-center lg:text-left">Ready to make a reservation?</h2>
  ...
  <div>
   <a href="/index.html"> <img src="/public/images/logo.svg" class="w-28 h-14 mb-8  cursor-pointer"/></a>
  </div>
