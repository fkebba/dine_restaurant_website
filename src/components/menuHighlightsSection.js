    ...
    <div class="bg-black py-12 md:py-8 lg:py-24 px-4 md:px-22 lg:px-0">
      <div class="block  lg:flex justify-between  md:mt-24 md:max-w-5xl mx-auto">
        <div class="max-w-fit  md:max-w-md mb-12 lg:mb-0 text-center lg:text-left mx-auto lg:mx-0">
          <img src="/public/images/patterns/pattern-divide.svg" class="mb-10 w-16 mx-auto lg:mx-0" />
        ...
        <div class="grid grid-cols-1  max-w-full lg:max-w-md gap-y-2 md:gap-y-8 gap-8">
          <div class="flex flex-col md:flex-row items-center relative text-center md:text-left">
            <div class="">
             <img src="/public/images/homepage/salmon-desktop-tablet@2x.jpg" class="relative hidden md:block " />
              <img src="/public/images/homepage/salmon-mobile.jpg" class="relative md:hidden mb-8 " />
             </div>
            <div class="hidden md:block relative w-10">
              <img src="/public/images/patterns/pattern-divide.svg" class="absolute w-24 h-auto left-2/8 top-0  -translate-x-1/2 -translate-y-7 " />
            </div>
            <div>
          ...
          <div class="flex flex-col md:flex-row items-center   relative text-center md:text-left">
            <div class="">
             <img src="/public/images/homepage/beef-desktop-tablet@2x.jpg" class="relative hidden md:block  " />
              <img src="/public/images/homepage/beef-mobile.jpg" class="relative md:hidden mb-8 " />
            </div>
            <div class="hidden md:block relative w-14">
              <img src="/public/images/patterns/pattern-divide.svg" class="absolute w-16 h-auto left-2/8 top-0  -translate-x-1/2 -translate-y-7" />
            </div>
            <div>
           ...
           <div class="flex flex-col md:flex-row items-center mb-8 relative text-center md:text-left">
            <div>
             <img src="/public/images/homepage/chocolate-desktop-tablet@2x.jpg" class="relative hidden md:block " />
